    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="page-header">
                <h1 class="text-orange">CREATE EVENT</h1>
            </div>
				...
				<div class="input-group date">
					<input type="text" id="data_inicio" name="data_inicio" class="form-control" value="{{ old('data_inicio') }}" />
				...
				<div class="input-group date">
					<input type="text" id="data_fim" name="data_fim" class="form-control" value="{{ old('data_inicio') }}" />
					<span class="input-group-addon">
						<span class="glyphicon glyphicon-calendar"></span>
					</span>
				</div>
                            ...
                            <div class="form-group{{ $errors->has('titulo') ? ' has-error' : ''}}">
                                <label>Título</label>
                                <input class="form-control" name="titulo" placeholder="II Evento 2016" type="text" value="{{ old('titulo') }}">
                            ...
                            <div class="form-group{{ $errors->has('online') ? ' has-error' : ''}}">
                                <label>Online</label>
                                <input class="checkbox-inline" name="online" type="checkbox">
                            ...
                            <div class="form-group{{ $errors->has('pais_sigla') ? ' has-error' : ''}}">
                                ...
                                <input class="form-control" name="pais_sigla" placeholder="BR" type="text" value="{{ old('pais_sigla') }}">
                            ...
                            <div class="form-group{{ $errors->has('localizacao') ? ' has-error' : ''}}">
                                ...
                                <textarea class="form-control" name="localizacao">{{ old('localizacao') }}</textarea>
                            ...
                            <div class="form-group">
                                <div class="col-md-8 col-md-offset-2 text-center">
                                    <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-ok"></span> Criar Evento</button>
...
@section('extra-js')
    ...
    <script>
        ...
        $('#event-create').submit(function(e) {
            $('#data_inicio').data('DateTimePicker').format('YYYY-MM-DD H:mm:ss');
            $('#data_fim').data('DateTimePicker').format('YYYY-MM-DD H:mm:ss');
	});
    </script>
@endsection
