...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'i2272491_bb1', 'W.n4vkrvGlofKARYn~.01(.4', 'i2272491_bb1', '', false, false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbuser' => 'i2272491_bb1',
            'dbal.dbpasswd' => 'W.n4vkrvGlofKARYn~.01(.4',
            'dbal.dbname' => 'i2272491_bb1',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
